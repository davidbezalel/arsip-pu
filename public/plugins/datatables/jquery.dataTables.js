...
(/** @lends <global> */function( $ ) {
	 ...
	 * completely, but that is a massive mount of work and will break current
	...
	DataTable.defaults = {
		 ...
		 * each row until they are needed for a draw - saving a significant mount of
		 * time.
		 *  @type boolean
		 *  @default false
		 *
		 ...
		 * large mounts of data where it can take a noticeable mount of time to sort
		 * the entries.
		 *  @type boolean
		 *  @default false
		 *
